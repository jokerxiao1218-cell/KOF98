...
# 轻脚 st_B 的挥出腿:前踢 snap kick——膝顶到腰带高(整件顶=腰 y54),
# 小腿自膝向前下弹出,脚停在腰高即止(踢位短);支撑腿全长站地、
# 连续无断口,鞋底贴到画布底 y99。与 st_D 的 leg_sidekick(水平长直
# 全伸、鞋在 y67-72)剪影区分:本件膝抬到 y54-57、鞋在 y60-65、
# 伸及 x41——更高更短且有屈膝折角,一眼可分。
PARTS_EXTRA = {
    "atk_snapkick": [
        "........ppppppppppppp...........",  # 髋块+膝起:腰行
        "........pppppppppppppp..........",
        "........ppppppppppppppp.........",  # 膝(件列18-22)
        ".......Pppppppppppppppp.........",
        ".......Ppppppppppp..pppp........",  # 小腿起:斜向前下
        ".......Ppppppppppp...pppp.......",
        "......Ppp.............pppprrrr..",  # 支撑腿接续+鞋面起
        "......Ppp..............pprrwrr..",
        "......Ppp...............prrwrr..",  # 踝接鞋(腰高)
        "......Ppp................rrrrr..",
        "......Ppp................WWWWW..",  # 鞋底(踢脚)
...
# 三段式:起手(提膝蓄力,拳收胸口,躯干后坐)→ 挥出(前踢 snapkick:膝顶
# 腰带前、小腿前弹到腰高,踢位短而快,双臂平衡)→
# 收招(踢腿前落成走步位,臂收回护颌)。轻脚与 st_D 的高抡横踢
# (leg_sidekick 长直全伸)剪影一眼可分:本帧膝高+短踢+屈膝折角。
POSE_TABLE["st_B"] = (
    _stand("wind", 30, 22, legs="knee", lg_dx=16, torso_dx=-1, head_dx=-1),
    _f(("arm_kick_bal", 25, 26), ("atk_snapkick", 12, 54),
